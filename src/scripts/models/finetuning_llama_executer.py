...
def main(args):
    ...
    train_llama(hg_token, wandb_token, base_model_name, model_save_dir, output_model_name, instructions_path, dataset_path)


if __name__ == "__main__":
    parser = ArgumentParser("Execute the script to fine tune a llama model")
    parser.add_argument("hg_token", help="The hugging face token.")
    parser.add_argument("wandb_token", help="The wandb token.")
