...
def main(args):
    papers_pairs_info = join(args.papers_base_dir, 'papers_pairs.csv')
    ...
    generate_claims(papers_pairs_info, claims_base_path, input_text_type, annotation_dir, prompt_template, llm_api_type,
                    llm_model, llm_api_key, run_start=run_start, run_end=run_end)
